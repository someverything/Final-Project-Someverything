        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryLangId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Articles_CategoryLangs_CategoryLangId",
                        column: x => x.CategoryLangId,
                        principalTable: "CategoryLangs",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArticleLangs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ArticleLangs_Articles_ArticleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Articles_CategoryLangId",
                table: "Articles",
                column: "CategoryLangId");
